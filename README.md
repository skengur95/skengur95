...
**산업설비 진동 이상감지 시스템** (2026.09 ~ 2027.03)  
MCU에 진동 센서를 붙여 정상/이상을 기기 단독으로 판정합니다.  

| 단계 | 내용 |
|---|---|
| 1 | 레지스터 직접 제어, 인터럽트·타이머 |
| 2 | I2C IMU 100Hz 수집, FreeRTOS, 실시간성 측정 |
| 3 | FFT 특징 추출, 모델 학습 |
| 4 | 양자화 후 MCU 탑재, 메모리·지연·정확도 정량 비교 |
...
**Unity 기반 모바일 게임 2종 Google Play 출시**

- **막차로돌진** — [Play Store](https://play.google.com/store/apps/details?id=com.planz.makcharodoljin&hl=ko&pli=1)
- **낱말모아(WordFlow)** — [Play Store](링크)

기획부터 개발, 스토어 등록, 운영까지 1인 진행했습니다.
...
<!--
**skengur95/skengur95** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
